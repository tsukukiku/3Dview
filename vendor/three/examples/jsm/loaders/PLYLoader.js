 ...
 * 窶彭iffuse_(red|green|blue)窶・in the file to standard color names.
 *
 ...
 * For example, the following maps the element properties 窶彡ustom_property_a窶・ * and 窶彡ustom_property_b窶・to an attribute 窶彡ustomAttribute窶・with an item size of 2.
